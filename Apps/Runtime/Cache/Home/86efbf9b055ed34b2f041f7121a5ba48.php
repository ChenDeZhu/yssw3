...
<html>
		...
		<div class="mui-content topws">
			...
			<form class="mui-input-group topes">
				...
				<div class="mui-button-row">
					<button type="button" class="mui-btn mui-btn-primary recharge">充值账户</button>&nbsp;&nbsp;
					<button type="button" class="mui-btn mui-btn-danger withdrawals">余额提现</button>
				</div>
			</form>
	...
	<script>
        ...
        mui('.recharge')[0].addEventListener('tap',function(){
        	mui.toast('系统繁忙，请稍后再试1');
        })
        //提现操作
        mui('.withdrawals')[0].addEventListener('tap',function(){
        	mui.toast('系统繁忙，请稍后再试2');
        })

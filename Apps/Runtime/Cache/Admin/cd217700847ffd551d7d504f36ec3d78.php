...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 企业管理 <span class="c-gray en">&gt;</span>编辑企业 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" id="btn-refresh"><i class="Hui-iconfont" id="btn-refresh">&#xe68f;</i></a></nav>

<article class="page-container">
	<form action="<?php echo U('Company/update');?>" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data"  onsubmit="return check()">
  ...
  <div class="row cl">
      ...
      <div class="main-upload">
            <div class="main-img">
              ...
              <img id="preview2" src="<?php echo ($info['img']); ?>" width="100%"> </div>
          </div>
    </div>
  ...
  <div class="row cl">
      ...
      <div class="formControls col-xs-5 col-sm-6">
        <input type="text" class="input-text radius" value="<?php echo ($info["tel"]); ?>" placeholder="" id="tel" name="tel">
      </div>
    </div>
  <div class="row cl">
      <label class="form-label col-xs-4 col-sm-3">传真：</label>
      <div class="formControls col-xs-5 col-sm-6">
        <input type="text" class="input-text radius" value="<?php echo ($info["fax"]); ?>" placeholder="" id="fax" name="fax">
      </div>
    </div>
  <div class="row cl">
      <label class="form-label col-xs-4 col-sm-3">地址：</label>
      <div class="formControls col-xs-5 col-sm-6">
        <input type="text" class="input-text radius" value="<?php echo ($info["address"]); ?>" placeholder="" id="address" name="address">
      </div>
    </div>
    <div class="row cl">
          ...
          <div class="formControls col-xs-5 col-sm-6">
                 <div class="radio-box">
                    <input type="radio" id="radio-1" name="recommend" value="0" <?php if(0 == $info['recommend']): ?>checked<?php endif; ?>>
                    <label for="radio-1">是 </label>
                  </div>
                <div class="radio-box">
                    <input type="radio" id="radio-2" name="recommend" value="1" <?php if(1 == $info['recommend']): ?>checked<?php endif; ?>>

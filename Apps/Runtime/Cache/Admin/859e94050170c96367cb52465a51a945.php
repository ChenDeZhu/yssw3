...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-gonggao">
			...
			<dd>
				<ul>
					...
					<li><a _href="<?php echo U('Cate/index',array('type'=>0));?>" data-title="招聘栏目" href="javascript:void(0)">招聘栏目</a></li>
					<li><a _href="<?php echo U('Information/index',array('type'=>0));?>" data-title="招聘列表" href="javascript:void(0)">招聘列表</a></li>
					<li><a _href="<?php echo U('Cate/index',array('type'=>1));?>" data-title="求职栏目" href="javascript:void(0)">求职栏目</a></li>
		...
		<dl id="menu-gonggao">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo U('Cate/index',array('type'=>2));?>" data-title="供应栏目" href="javascript:void(0)">供应栏目</a></li>
					<li><a _href="<?php echo U('Information/index',array('type'=>2));?>" data-title="供应列表" href="javascript:void(0)">供应列表</a></li>
					<li><a _href="<?php echo U('Cate/index',array('type'=>3));?>" data-title="求购栏目" href="javascript:void(0)">求购栏目</a></li>
		...
		<dl id="menu-gonggao">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo U('Cate/index',array('type'=>4));?>" data-title="出租栏目" href="javascript:void(0)">出租栏目</a></li>
					<li><a _href="<?php echo U('Information/index',array('type'=>4));?>" data-title="出租列表" href="javascript:void(0)">出租列表</a></li>
					<li><a _href="<?php echo U('Cate/index',array('type'=>5));?>" data-title="转让列表" href="javascript:void(0)">转让栏目</a></li>
					<li><a _href="<?php echo U('Information/index',array('type'=>5));?>" data-title="转让栏目" href="javascript:void(0)">转让列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-gonggao">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo U('Company/index');?>" data-title="公司列表" href="javascript:void(0)">企业列表</a></li>
					<li><a _href="<?php echo U('Website/profile');?>" data-title="我的公司信息" href="javascript:void(0)">我的公司信息</a></li>

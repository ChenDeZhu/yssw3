...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 新闻发布<span class="c-gray en">&gt;</span> 修改新闻 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" id="btn-refresh"><i class="Hui-iconfont" id="btn-refresh">&#xe68f;</i></a></nav>

<article class="page-container">
  <form action="<?php echo U('Product/upting');?>" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data"  onsubmit="return check()">
    <div class="row cl">
        ...
        <div class="formControls col-xs-5 col-sm-6">
            <span class="select-box">
              <select class="select" size="1" name="pid" id="pid">
                    <?php if(is_array($plist)): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $pinfo['pid']): ?>selected<?php endif; ?>><?php echo ($v["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
            </span>
        </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-xs-5 col-sm-6">
        <input type="text" class="input-text radius" value="<?php echo ($pinfo["title"]); ?>" placeholder="" name="title" id="title">
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-3">内容：</label>
      <div class="formControls col-xs-5 col-sm-6">
        <script id="editor" type="text/plain" style="width:800px;height:400px;"><?php echo ($pinfo["content"]); ?></script>
      </div>
    </div>
    <label class="form-label col-xs-4 col-sm-3" style="height:100px; line-height: 140px"><span class="c-red">*</span>新闻logo：大小321*211</label>
    <div class="main-upload">
          <div class="main-img">
            ...
            <img id="preview2" src="<?php echo ($pinfo["plogo"]); ?>"  style="display: block; width: 100%">
        </div>
    </div>
    <input type="hidden" name="nid" value="<?php echo ($pinfo["id"]); ?>">
